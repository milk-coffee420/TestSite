    ...
    <main class="admin">
        <div class="admin_content">
            ...
            <div class="admin_link_btn">
                <a href="{{ action('NewsController@create') }}" class="button is-primary is-hovered is-rounded">新規作成</a>
                <a href="{{ action('NewsController@getTrashed') }}" class="button is-rounded is-hovered is-primary is-light"><i class="fas fa-trash-alt"></i></a>
            </div>
                ...
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            {!! Form::model($item, ['action' => ['NewsController@destroy', $item->id], 'id' => 'delete_form'.$item->id]) !!}
                                {{ csrf_field() }}
