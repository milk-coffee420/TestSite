...
@section('content')
    ...
    <main class="admin">
        <div class="admin_content">
            <h2 class="admin_pagetitle subtitle">お知らせ / ごみ箱</h2>
                    ...
                    @foreach ($items as $item)
                        <tr>
                            ...
                            <td>
                                ...
                                {!! Form::model($item, ['action' => ['NewsController@restore', $item->id], 'id' => 'restore_form'.$item->id]) !!}
                                    {{ csrf_field() }}
                                {!! Form::close() !!}
                                    ...
                                    <div class="modal-card">
                                        ...
                                        <div class="modal-card-foot">
                                            ...
                                            <div class="modal_card_foot_content">
                                                {!! Form::model($item, ['action' => ['NewsController@forceDelete', $item->id]]) !!}
                                                    {{ csrf_field() }}
            ...
            <a class="button is-rounded is-info is-outlined admin_return_btn" href="{{ action('NewsController@index') }}">戻る</a>
